  ...
  <div id="root">
        <div class="todo-container">
            <div class="todo-wrap">
                ...
                <todo-list :todos="todos" :checkTodo="checkTodo" :delTodo="delTodo"></todo-list>
                <todo-footer :todos="todos" :allCheaked="allCheaked" :clearCheaked="clearCheaked"></todo-footer>
            </div>
        </div>
    </div>
</template>
